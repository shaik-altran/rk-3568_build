...
u-boot: rkbin
	...
	$(U-BOOT_EXPORTS) $(MAKE) -C $(U-BOOT_PATH) O=$(BINARIES_PATH)/u-boot BL31=$(ROOT)/rkbin/bin/rk35/rk3568_bl31_v1.25.elf all ./tools/mkimage -n "rk3568" -T rksd -d $(ROOT)/rkbin/bin/rk35/rk3568_dd		    r_1560MHz_v1.08.bin:spl/u-boot-spl.bin idbloader.img
